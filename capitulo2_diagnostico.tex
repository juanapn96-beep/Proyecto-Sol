...
De acuerdo con la Ley 689 de 2001, que modifica parcialmente la Ley 142 de 1994, la Superintendencia de Servicios Públicos Domiciliarios (SSPD) es la entidad encargada de administrar, mantener y operar el Sistema Único de Información (SUI), con base en la información que reportan los prestadores de servicios públicos domiciliarios. Esto garantiza que la información presentada al público sea confiable y verificable. En virtud de lo anterior y de la definición legal de los barrios subnormales contenida en el DUR 1073 de 2015, la SSPD cuenta con reportes que permiten identificar la existencia de barrios subnormales desde la década de los 2000; sin embargo, la existencia de estos reportes no es condición suficiente para que los OR puedan presentar proyectos de normalización ante el PRONE, pues para ello se requiere la certificación del alcalde municipal o distrital mencionada en el requisito (iii) de la definición legal.

Hay dos implicaciones prácticas que conviene subrayar desde el principio. La primera: que un barrio sea subnormal no significa que el OR tenga prohibido prestar el servicio; solo significa que aún no ha sido normalizado. La segunda, y más crítica para el PRONE: sin la certificación del alcalde o la autoridad competente, ningún OR puede presentar un proyecto de normalización al MME. Un asentamiento puede llevar treinta años en esas condiciones y seguir siendo inelegible para el programa si el ente territorial no ha expedido esta constancia. Esta barrera institucional ha frustrado la participación de OR que tienen capacidad técnica pero no logran que las alcaldías actúen, como documentan \textcite{CabralesSanjuan2015} para el caso de CENS. El Capítulo~\ref{chap:normativo} analiza esta dinámica con mayor detalle.
...
\bottomrule
\multicolumn{4}{p{\textwidth}}{\footnotesize \textsuperscript{a} El número de familias coincide con el de barrios; el dato proviene del reporte individual de la Empresa de Energía de Arauca ante la SSPD, sin que se disponga de un consolidado regional que permita verificarlo.}\\
\multicolumn{4}{p{\textwidth}}{\footnotesize \textit{Fuente: Elaboración propia con datos del Formato 11 -- Herramienta O3 \parencite{SSPD2020}.}}
\end{tabularx}
\end{table}

El plan quinquenal de Air-e para 2023 permite actualizar los datos de la Tabla~\ref{tab:bs_colombia}: ese OR atendía 165.554 usuarios subnormales, equivalentes al 16,8\% de sus clientes en estratos 1, 2 y 3. Comparado con las 162.604 familias reportadas en el Formato~11 a 2020, eso representa un crecimiento del 1,81\% \parencite{Aire2023, SSPD2020}. Afinia reportó en 2021 un incremento del 10,4\%, con 152.360 usuarios \parencite{Afinia2021}.
