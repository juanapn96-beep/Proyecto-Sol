...
\textbf{SSPD:} Administra el SUI, que centraliza los reportes de los OR
sobre los BS certificados. Es la fuente primaria para identificar y
cuantificar los asentamientos elegibles para intervención.
...
subnormalidad ni qué tan bien esté diseñado el proyecto técnico. Las
alcaldías también son actores clave en la gestión social previa y en la
articulación con la comunidad durante las obras.
...
construidos con recursos del PRONE. Su constitución requiere un proceso
de formación comunitaria que debe iniciarse con suficiente anticipación
a la finalización de las obras \parencite{Decreto2236_2023}.
...
\begin{itemize}
    ...
    unitarios verificables y valores totales.
...
La metodología se organiza en cinco fases secuenciales. Cada fase tiene
un objetivo claro, actores responsables definidos, entregables mínimos y
un criterio de avance que determina cuándo puede pasarse a la siguiente.
No se puede saltar una fase. Intentarlo es exactamente lo que explica
por qué tantos proyectos llegan incompletos al CAPRONE.
...
\textbf{Entregables:} Informe de diagnóstico integral, certificación de
BS vigente (o constancia de gestión), censo de usuarios con levantamiento
técnico y datos de recurso solar del sitio.
...
\textbf{Riesgo principal:} Que la alcaldía demore o niegue la
certificación. Mitigación: iniciar las gestiones seis meses antes de
la convocatoria y mantener seguimiento activo con la entidad territorial.

\subsection{Fase 2 -- Diseño técnico del proyecto}
\label{subsec:fase2}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=1.8cm, itemsep=6pt]
    ...
    con la autonomía y profundidad de descarga requeridas.
    ...
    escenarios (solo red vs. red con AGPE).
\end{enumerate}

\textbf{Entregables:} Diseño eléctrico completo de la red, especificaciones
y dimensionamiento del AGPE, verificación de capacidad de conexión,
presupuesto integrado con costo por usuario, y decisión documentada
sobre el modelo de propiedad de los activos.
...
\subsection{Fase 3 -- Gestión social y comunitaria}
\label{subsec:fase3}
...
Esta fase no tiene un inicio y un fin discretos. Empieza en el
diagnóstico y no termina hasta al menos un año después de la
energización. Sus momentos más intensivos son tres:
...
\textbf{Entregables:} Plan de gestión social documentado, actas de
sesiones de socialización, acuerdo con el suscriptor comunitario o JAC,
decisión documentada sobre las deudas históricas, acto de constitución
de la Comunidad Energética (si aplica) e informes de seguimiento
post-normalización.
...
\subsection{Fase 4 -- Estructuración y presentación del proyecto ante el PRONE}
\label{subsec:fase4}

\textbf{Objetivo:} Consolidar un expediente completo, coherente y
elegible, y presentarlo al MME dentro del plazo de la convocatoria.
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=1.8cm, itemsep=6pt]
    ...
    \item \textbf{Consolidar el expediente:} Certificación del BS,
    diagnóstico integral, diseño técnico completo (planos, memorias,
    unifilares), especificaciones del AGPE, verificación del límite del
    50\%, presupuesto detallado, plan de gestión social, acuerdos
    comunitarios, análisis de impacto tarifario y, si aplica, acto de
    ...
    \item \textbf{Atender las solicitudes de información adicional} del
    CAPRONE durante la evaluación, dentro de los plazos establecidos.
\end{enumerate}

\textbf{Entregables:} Expediente completo radicado, constancia de
radicado y respuestas documentadas al CAPRONE (si aplica).
...
\subsection{Fase 5 -- Ejecución, energización y sostenibilidad}
\label{subsec:fase5}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=1.8cm, itemsep=6pt]
    ...
    aprobado. La interventoría es obligatoria y su costo debe estar en
    el presupuesto.
...
\textbf{Entregables:} Acta de energización de la red y del AGPE, acta
de entrega de activos a la Comunidad Energética (si aplica), informes
de seguimiento a los 12 y 36 meses y plan de AOM documentado.
...
% ─────────────────────────────────────────────────────────────
\section{Vacíos Regulatorios Identificados y Recomendaciones}
\label{sec:vacios}
% ─────────────────────────────────────────────────────────────
...
\textit{Recomendación:} El MME y la CREG deberían definir un esquema de
remuneración para la Comunidad Energética, estructurado como un
porcentaje de los excedentes entregados a la red o como reconocimiento
tarifario dentro del FOES.
...
\textit{Recomendación:} El MME, la CREG y la UPME deben desarrollar una
disposición que defina el cálculo del FOES para usuarios con AGPE,
proporcional al consumo neto de la red.
...
\textit{Recomendación:} Incluir en futuras resoluciones criterios
diferenciados que valoren el recurso solar disponible, el impacto en
la factura del usuario, el potencial de reducción de pérdidas y la
solidez del plan de AOM.
...
\textit{Recomendación:} Incorporar en el esquema del PRONE informes
de impacto obligatorios a los 24 y 48 meses de la energización, y
vincular el desempeño en proyectos anteriores a la elegibilidad para
