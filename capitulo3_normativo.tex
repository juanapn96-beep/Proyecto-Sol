...
El marco normativo que regula la normalización de redes eléctricas en Colombia lleva más de tres décadas construyéndose, y no lo ha hecho de manera ordenada. Ha respondido a presiones sociales, a aprendizajes de campo y, más recientemente, a los compromisos del PND 2022--2026 con la transición energética. Entender esa trayectoria ayuda a explicar por qué el esquema actual tiene las oportunidades que tiene, pero también los vacíos que tiene.
...
La \textbf{Ley 143} complementó este marco para el sector eléctrico específicamente. Su artículo 11 definió el consumo básico de subsistencia como la cantidad mínima de electricidad mensual que un usuario típico necesita para satisfacer sus necesidades básicas. El artículo 48 ordenó al Gobierno Nacional destinar recursos del PND a programas de energización prioritarios para lograr cobertura igualitaria en el país. El artículo 66 estableció el ahorro y la eficiencia energética como objetivos del sector \parencite{Ley143_1994}. Ese mandato de eficiencia, formulado treinta años antes, anticipa de alguna manera el papel que el AGPE terminaría cumpliendo dentro del PRONE.

\subsection{La creación del PRONE (2003--2006)}
\label{subsec:creacion_prone}

El PRONE nació en el PND 2003--2006, aprobado por la \textbf{Ley 812 de 2003}, que en su artículo 63 lo creó como instrumento de financiamiento para la normalización de redes \parencite{Ley812_2003}. Tres años después, la \textbf{Ley 1117 de 2006} le dio soporte legal definitivo y lo constituyó formalmente como fondo administrado por el MME, con el propósito de financiar planes, programas y proyectos para legalizar usuarios y adecuar las redes en los BS del SIN \parencite{Ley1117_2006}.

La reglamentación detallada llegó con el \textbf{DUR 1073 de 2015}, artículo 2.2.3.3.3.1.1, que delimitó con precisión qué puede y qué no puede financiarse con el programa: \textit{``únicamente el suministro e instalación de las redes de distribución, los transformadores de distribución, las acometidas a las viviendas de los usuarios y los medidores o sistema de medición del consumo. En lo referente al desmonte del material existente [\ldots] su costo no podrá superar el tres por ciento (3\%) del valor total del proyecto''} \parencite{DUR1073_2015}. Esa lista es importante para quien formule un proyecto: lo que no está en ella, no se paga con el PRONE.

El DUR también define quiénes pueden presentar proyectos, los requisitos mínimos, los criterios de priorización y las condiciones de propiedad de los activos una vez terminadas las obras. Es el ecosistema institucional completo dentro del cual operan los OR que buscan financiamiento público para normalización.

El mismo DUR consolidó la reglamentación del \textbf{FOES}, subsidio para usuarios de estratos 1 y 2 en áreas especiales. Su aplicación depende del consumo de subsistencia definido por la UPME, del porcentaje de recaudo del OR —la cobertura del subsidio varía entre el 40\% y el 100\% según ese indicador— y de la certificación anual del área especial ante la SSPD \parencite{DUR1073_2015}.
...
Para aplicar cualquiera de estos esquemas, el OR debe firmar contratos con suscriptores comunitarios que definan cómo se mide, cómo se factura y cómo se paga. El problema práctico es que el suscriptor comunitario no tiene herramientas legales reales para exigir el pago a los usuarios individuales. La responsabilidad se diluye, nadie responde de verdad, y eso alimenta exactamente la ``cultura del no pago'' que los expertos consultados identificaron como el obstáculo central de la normalización.
...
En teoría, eso crea un incentivo para que los OR normalicen los BS. En la práctica, como señaló el experto E12 en la consulta, los costos iniciales de un proyecto de normalización —infraestructura, acompañamiento social, condonación de deudas— pueden superar los beneficios tarifarios durante los primeros años. El incentivo existe, pero no siempre es suficiente para mover la aguja.

\subsection{La incorporación del AGPE al PRONE (2023--2024)}
\label{subsec:agpe_prone}

El cambio normativo más importante en los veinte años de historia del PRONE llegó con el \textbf{PND 2022--2026}, aprobado por la \textbf{Ley 2294 de 2023}: por primera vez, los recursos del programa pueden destinarse a incluir sistemas AGPE dentro de los proyectos de normalización \parencite{Ley2294_2023}.
...
La primera convocatoria con el componente AGPE fue la \textbf{Resolución 40243 de 2025} \parencite{ResolucionMME40243_2025}. El resultado fue elocuente: ninguno de los proyectos presentados cumplió con todos los requisitos del MME \parencite{MME2025}. Ese dato confirma, de la manera más directa posible, la brecha metodológica que esta monografía busca cerrar.
...
La \textbf{Ley 143 de 1994} definió al autogenerador como ``aquel generador que produce energía eléctrica exclusivamente para atender sus propias necesidades'' \parencite{Ley143_1994}. Autoconsumo puro. Nada de excedentes, nada de red comunitaria, nada de política energética.

La \textbf{Resolución 84 de 1996} operativizó eso con un esquema aún más restrictivo: el autogenerador conectado al SIN no podía vender excedentes, salvo en situaciones de racionamiento y solo a través de la Bolsa de Energía. La conexión al sistema se concebía exclusivamente como respaldo. Para los usuarios regulados, el suministro iba obligatoriamente a través del comercializador del área; los no regulados podían contratar libremente.

Durante casi dos décadas ese esquema se mantuvo. El resultado práctico fue que la autogeneración quedó reducida a una opción de nicho para grandes industrias con capacidad de inversión y sin posibilidad de recuperarla inyectando a la red. En ese contexto, pensar en autogeneración para comunidades en BS no tenía ningún sentido regulatorio.
...
\begin{itemize}
    \item \textbf{El límite de inyección subió del 15\% al 50\%} de la capacidad del transformador o circuito al que se conecta el AGPE. Para los circuitos que sirven a los BS, que generalmente tienen capacidades limitadas, el umbral del 15\% era un obstáculo frecuente. Con el 50\% la viabilidad técnica de estos proyectos mejora significativamente.
    ...
    \item \textbf{Se definió el manejo de excedentes vía tarifa}, distinguiendo el caso en que los excedentes superan las importaciones (permuta) del caso en que son menores o iguales. Esa precisión alinea la regulación con la realidad técnica de la medición bidireccional.
\end{itemize}
...
Tres décadas de proyectos de normalización en Colombia dejan un registro valioso de qué funciona y qué no. Esta sección analiza los tres casos con mayor documentación disponible en la literatura, y complementa ese análisis con el comportamiento histórico de los proyectos del PRONE entre 2005 y 2025.

\subsection{Caso 1 -- Cartagena, Bolívar (1991)}
\label{subsec:caso_cartagena}

En 1991, la Electrificadora de Bolívar evaluó la viabilidad de construir redes de distribución en zonas subnormales de Cartagena usando el método de normalización por tramos secundarios \parencite{CastilloQuintana1991}. Es uno de los primeros estudios documentados de este tipo en el país.
...
Al cierre de 2013 se habían ejecutado 38.285 legalizaciones y normalizado 110.064 usuarios en total \parencite{MendezFuentes2013}. Los resultados son sólidos. Pero la lección más importante es sobre escala: una inversión de \$114.885 millones con recursos propios está fuera del alcance de la mayoría de los OR del país, especialmente de los que operan en el Caribe con los problemas financieros documentados en el Capítulo~\ref{chap:diagnostico}. Sin el PRONE, este tipo de proyectos no es replicable.

\subsection{Caso 3 -- Popayán, Cauca (2014--2018)}
\label{subsec:caso_popayan}

La experiencia de la Compañía Energética de Occidente (CEO) en Popayán es la más estudiada en la literatura colombiana sobre normalización, y con razón: sus resultados son los mejores documentados, y el proceso que los produjo es el más integral \parencite{SerranoRueda2019}.
...
A partir de las actas CAPRONE y los informes de evaluación del MME se construyó una base de datos de proyectos por vigencia, OR, municipio, número de beneficiarios y valor solicitado \parencite{MME2025}. Los patrones más relevantes son:

La concentración geográfica es consistente: región Caribe, región Pacífica y algunos departamentos andinos acumulan la mayoría de los proyectos. Orinoquía y Amazonía tienen participación marginal, coherente con la distribución de los BS en el SIN.

El 52,03\% de los proyectos presentados entre 2005 y 2025 provienen de la Electrificadora de la Costa Caribe (hoy Afinia y Air-e). Esa concentración refleja el tamaño del problema en esa región, pero no implica calidad en la formulación: en 2024, ningún proyecto de esos OR —ni de ningún otro— resultó elegible.

Las variaciones anuales más notorias son:
...
\begin{tabularx}{\textwidth}{>{\RaggedRight}p{2.8cm}
                             >{\RaggedRight}p{3.0cm}
                             >{\RaggedRight}p{3.5cm}
