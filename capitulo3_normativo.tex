...
\begin{itemize}
    \item \textbf{El límite de inyección subió del 15\% al 50\%} de la capacidad del transformador o circuito al que se conecta el AGPE. El umbral de penetración de generación distribuida define la máxima potencia que un sistema AGPE puede inyectar a un punto de la red sin comprometer la estabilidad del circuito ni requerir refuerzos adicionales en la infraestructura. Para los circuitos que sirven a los BS, que generalmente tienen capacidades nominales relativamente bajas, el umbral anterior del 15\% restringía de manera significativa el tamaño del sistema AGPE que podía instalarse: por ejemplo, en un transformador de 75~kVA, el límite pasó de 11,25~kW a 37,5~kW de potencia instalable. Con el nuevo límite del 50\%, la potencia de generación que puede conectarse al mismo punto aumenta considerablemente, lo que mejora la viabilidad técnica y económica de estos proyectos al permitir sistemas de mayor tamaño sin inversiones adicionales en infraestructura de red.
    ...
    \item \textbf{Se definió el manejo de excedentes vía tarifa}, estableciendo dos escenarios. En el primero, cuando la energía que el AGPE inyecta a la red es menor o igual a la que importa desde ella, los excedentes se descuentan directamente de la factura del usuario como un crédito energético. En el segundo, denominado permuta, cuando los excedentes superan las importaciones —es decir, el AGPE entrega más energía de la que toma— el OR compensa al usuario por ese excedente neto a una tarifa definida por la CREG. Esa distinción alinea la regulación con la realidad técnica de la medición bidireccional y define con claridad cómo se liquida el intercambio de energía entre el usuario y el OR.
\end{itemize}

\subsection{La integración del AGPE en la normalización (2023--2025)}
\label{subsec:integracion_agpe_normalizacion}

Como se señaló en la Sección~\ref{subsec:agpe_prone}, el Decreto 1023 de 2024 es la pieza normativa que hace posible lo que propone esta monografía. Integra el AGPE dentro del PRONE y crea la distinción de propiedad que ya se mencionó: la red normalizada queda bajo el OR para efectos de AOM; los activos de generación pueden transferirse a la Comunidad Energética. Esa distinción tiene consecuencias sobre quién responde por qué en el largo plazo, y requiere que el proyecto la defina con claridad desde el inicio \parencite{Decreto1023_2024}.
...
Tres décadas de proyectos de normalización en Colombia dejan un registro valioso de qué funciona y qué no. Los tres casos con mayor documentación disponible en la literatura se analizaron por separado, y, de manera complementaria, se analizó el comportamiento histórico de los proyectos del PRONE entre 2005 y 2025.
